...
int PlayBuffer(short *piBuf, long lSamples)
{
	...
	// I REMOVED THIS ERROR (szErrBuf incompatible)
	//if (mmErr != MMSYSERR_NOERROR) {
	//	char	szErrBuf[150];
	//	waveOutGetErrorText(mmErr, szErrBuf, sizeof(szErrBuf));
	//	printf("Error 0x%x writing to playback device. %s", mmErr, szErrBuf);
	//	return(0);
	//}
...
int	RecordBuffer(short *piBuf, long lBufSize)
{
	...
	// I COMMENTED THIS OUT DUE TO ERROR (szErrBuf incompatible)
	//if (mmErr != MMSYSERR_NOERROR) {
	//	char	szErrBuf[150];
	//	waveOutGetErrorText(mmErr, szErrBuf, sizeof(szErrBuf));
	//	printf("Error 0x%x writing to playback device. %s", mmErr, szErrBuf);
	...
	// I COMMENTED THIS OUT DUE TO ERROR 
	//if (mmErr != MMSYSERR_NOERROR) {
	//	char	szErrBuf[150];
	//	waveOutGetErrorText(mmErr, szErrBuf, sizeof(szErrBuf));
	//	printf("Error 0x%x writing to playback device. %s", mmErr, szErrBuf);
